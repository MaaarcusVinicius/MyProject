object form_relatorio_agendamento_profissional: Tform_relatorio_agendamento_profissional
  Left = 0
  Top = 0
  ClientHeight = 684
  ClientWidth = 798
  ...
  Font.Style = []
  TextHeight = 15
  object rlr_agendamentos_profissional: TRLReport
    Left = -4
    Top = 0
    Width = 794
    Height = 1123
    ...
    object rlr_band_1: TRLBand
      ...
      object Tlbl_titulo: TRLLabel
        ...
        Align = faTop
        Alignment = taCenter
        Caption = 'RELAT'#211'RIO DE AGENDAMENTOS POR PROFISSIONAL'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -17
        Font.Name = 'Segoe UI'
      ...
      object lbl_profissional: TRLLabel
        Left = 0
        Top = 40
        Width = 718
        Height = 17
